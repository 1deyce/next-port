...
const Projects = () => {
    return (
        <section className="w-[800px]">
            <h1 className="flex justify-center items-center text-center text-4xl uppercase my-10 text-white">
                My Work
            </h1>
            <div className="flex justify-center items-center gap-12">
                <div className="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-400">
                    <div className="flex items-center justify-center h-48 mb-4 rounded-md">
                        <img
                            src="/bankapp.png"
                            width={250}
                            height={100}
